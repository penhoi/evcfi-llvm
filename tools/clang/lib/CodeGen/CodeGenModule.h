...
private:
  ...
  /// A queue of all vtables to consider emitting.
  std::vector<const CXXRecordDecl *> CXXRecordVTables;
...
public:
  ...
  void addCXXRecordVTable(const CXXRecordDecl *RD) {
    CXXRecordVTables.push_back(RD);
  }
